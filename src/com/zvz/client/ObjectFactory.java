 ...
 * generated in the com.zvz.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetValueResponse_QNAME = new QName("http://service.zvz.com/", "getValueResponse");
    private final static QName _GetValue_QNAME = new QName("http://service.zvz.com/", "getValue");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.zvz.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.zvz.com/", name = "getValueResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.zvz.com/", name = "getValue")
